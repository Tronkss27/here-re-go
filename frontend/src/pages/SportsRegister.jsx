    ...
    try {
      const result = await register({
        ...
        businessInfo: {
          ...
          // ✨ NUOVO: Includi tutti i campi aggiuntivi
    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-md">
        ...
        <p className="text-center text-gray-600 mb-6">
          Unisciti alla rete SPOrTS e raggiungi nuovi clienti
        </p>

        <div className="mb-6 p-4 bg-gradient-to-r from-sports-secondary to-sports-medium border border-sports-dark rounded-lg">
          <div className="flex items-center">
            <div className="text-sports-white text-2xl mr-3">🚀</div>
            <div>
              <h3 className="font-semibold text-sports-white">Porta il tuo locale su SPOrTS</h3>
              <p className="text-sports-white text-sm">
